...
type InputControllerHandlers = {
  onInsert?: (text: string) => void;
  onDelete?: (direction: "backward" | "forward") => void;
  onMove?: (direction: "left" | "right" | "up" | "down" | "lineStart" | "lineEnd") => void;
  onFocus?: () => void;
  onBlur?: () => void;
};
...
export class InputController {
  ...
  constructor(element: HTMLTextAreaElement, handlers: InputControllerHandlers = {}) {

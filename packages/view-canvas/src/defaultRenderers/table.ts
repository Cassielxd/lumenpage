/*
 * 鏂囦欢璇存槑锛氳〃鏍艰妭鐐规覆鏌撻厤缃拷? * 涓昏鑱岃矗锛氳绠楀崟鍏冩牸甯冨眬銆佽楂樹笌鍗曞厓鏍兼枃锟?runs锟? */
...
export const tableNodeSpecs: Record<string, any> = {
  table: {
    group: "block",
...
export const tableRenderer = {
  ...
  layoutBlock({ node, settings, registry }) {
    ...
    for (let r = 0; r < rows; r += 1) {
      ...
      // 璁板綍琛屽唴瀹归珮搴︼紙涓嶅惈涓婁笅 padding锟?      rowContentHeights[r] = maxContentHeight;

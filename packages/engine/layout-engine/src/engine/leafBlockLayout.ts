...
import { getBlockLayoutSignature } from "./signature.js";
import { breakRunsWithSettings } from "./textLayout.js";
...
/**
 * ����Ҷ�ӿ��ʵ�ʲ������ݣ�ͳһ�����������С��Զ��� layoutBlock ���ı����С�
 * �׶� 3 �Ȱ� measureBlock �Ľ���������������ı䵱ǰ legacy ��ҳ��Ϊ��
 */

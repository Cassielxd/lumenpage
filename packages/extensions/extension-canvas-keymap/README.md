...
> 目录：`packages/extensions/extension-canvas-keymap`
...
## 入口与结构
- 包名：`lumenpage-extension-canvas-keymap`
- 主要入口：`src/index.ts`
...
import CanvasKeymap from "lumenpage-extension-canvas-keymap";

const editor = new Editor({
  element,
  extensions: [CanvasKeymap],
});
```

...
> 目录：`packages/extensions/extension-smart-input-rules`
...
## 入口与结构
- 包名：`lumenpage-extension-smart-input-rules`
- 主要入口：`src/index.ts`
...
import SmartInputRules from "lumenpage-extension-smart-input-rules";

const editor = new Editor({
  element,
  extensions: [SmartInputRules],
});
```

...
const DEFAULT_ACTIONS: SelectionBubbleAction[] = [
  { id: "bold", label: "B", command: "toggleBold", markName: "strong" },
  { id: "italic", label: "I", command: "toggleItalic", markName: "em" },
...
const isTextRangeSelection = (selection: any) => {
  ...
  if (
    selectionType === "table_cell_selection" ||
    selectionType === "table_row_selection" ||
    selectionType === "table_col_selection"
  ) {
    return false;
  }

...
> 目录：`packages/extensions/extension-base-keymap`
...
## 入口与结构
- 包名：`lumenpage-extension-base-keymap`
- 主要入口：`src/index.ts`
...
import BaseKeymap from "lumenpage-extension-base-keymap";

const editor = new Editor({
  element,
  extensions: [BaseKeymap],
});
```

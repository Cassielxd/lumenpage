import {Slice, Fragment, ResolvedPos, Node} from "lumenpage-model"
import {ReplaceStep, ReplaceAroundStep} from "lumenpage-transform"
import type {Mappable} from "lumenpage-transform"
...
export abstract class Selection {
  ...
  replace(tr: Transaction, content = Slice.empty) {
    // 将新选区放置在插入内容之后的位置
    // 当内容以内联节点结束时，向后搜索以获取该节点之后的位�?    // 否则向前搜索

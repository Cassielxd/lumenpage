...
export type PaginationDocWorkerClientRequest = {
  doc: any;
  previousLayout: any;
  changeSummary: any;
  settings: any;
...
export class PaginationDocWorkerClient {
  ...
  constructor(workerUrl: URL) {
    ...
    this.worker.addEventListener("message", (event: MessageEvent<PaginationDocWorkerResponse>) => {
  ...
  requestLayout(args: PaginationDocWorkerClientRequest) {
    if (!this.worker) {

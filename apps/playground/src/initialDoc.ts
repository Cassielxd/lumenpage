...
const featureBlocks: JsonNode[] = [
  ...
  headingNode(2, "Lists"),
  {
    type: "bulletList",
    content: [
      { type: "listItem", content: [paragraphNode("Bullet item 1")] },
      { type: "listItem", content: [paragraphNode("Bullet item 2")] },
      { type: "listItem", content: [paragraphNode("Bullet item 3")] },
    ],
  },
  {
    type: "orderedList",
    attrs: { order: 1 },
    content: [
      { type: "listItem", content: [paragraphNode("Numbered item 1")] },
      { type: "listItem", content: [paragraphNode("Numbered item 2")] },
      { type: "listItem", content: [paragraphNode("Numbered item 3")] },
    ],
  },
  headingNode(2, "Media"),
  {
    ...
    content: [
      {
        type: "tableRow",
        content: [
          { type: "tableCell", content: [paragraphNode("A1")] },
          { type: "tableCell", content: [paragraphNode("B1")] },
          { type: "tableCell", content: [paragraphNode("C1")] },
        ],
      },
      {
        type: "tableRow",
        content: [
          { type: "tableCell", content: [paragraphNode("A2")] },
          { type: "tableCell", content: [paragraphNode("B2")] },
          { type: "tableCell", content: [paragraphNode("C2")] },
        ],
      },
      {
        type: "tableRow",
        content: [
          { type: "tableCell", content: [paragraphNode("A3")] },
          { type: "tableCell", content: [paragraphNode("B3")] },
          { type: "tableCell", content: [paragraphNode("C3")] },
        ],
      },
    ],
  },
